        ...
        <!-- Tabla Listado -->
          <div class="card">
            <div class="card-header">
              <button type="button" class="btn btn-secondary mt-1" @click="abrirModal('alumno','registrar')" data-toggle="modal" data-target="#modalNuevo">
                  ...
                  <thead>
                    ...
                    <tbody>
                      <tr v-for="alumno in arrayAlumno" :key="alumno.id_alumno">
                        <td>
                          <button type="button" @click="abrirModal('alumno', 'actualizar', alumno)" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modalNuevo">
                            <i class="icon-pencil"></i>
                          </button> &nbsp; <!--&nbsp; deja espacio -->
                          
                          <!-- Si el estado del alumno es activo, se muestra este botón -->
                          <template v-if="alumno.estado == 'A'">
                            <button type="button"  class="btn btn-danger btn-sm" @click="desactivarAlumno(alumno.id_alumno)">
                          ...
                          <template v-else>
                            <button type="button"  class="btn btn-info btn-sm" @click="activarAlumno(alumno.id_alumno)">
        ...
        <div class="modal-dialog modal-primary modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" v-if="tipoAccion==1" @click="registrarAlumno()" class="btn btn-primary">Guardar</button>
              <button type="button" v-if="tipoAccion==2" @click="actualizarAlumno()" class="btn btn-primary">Actualizar</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      validarAlumno(){
        ...
        if(!this.telefono){
          this.errores.telefono = {'error': 1, 'mensaje': 'El teléfono no puede ir vacío.'};
          this.errores.total_errores = 1;
        }
      ...
      cerrarModal(){
        ...
        this.errorAlumno = 0; // 0: No Existe un error
        this.errores = {
          "primer_nombre" : {'error': 0, 'mensaje': ''},
          "primer_apellido" : {'error': 0, 'mensaje': ''},
          "numero_identidad" : {'error': 0, 'mensaje': ''},
